...
from mi_app_de_cortes.src.services.styles_data import get_all_styles, get_style_prompt
...
def generate_recommendations(image_bytes: bytes, analysis: dict) -> list[dict]:
    """Generate 3 haircut recommendations with images."""
